                            ...
                            <div class="col-md-5">
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group ">                                        
                                        <label class="col-lg-4 control-label custom-label">Supplier Code :</label>
                                        <div class="col-lg-6">
                                            <input type="text" id="sup_code" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="sub_cat_name" class="col-lg-4 control-label custom-label">Supplier Name :</label>
                                        <div class="col-lg-6">
                                            <input type="text" id="sup_name" class="form-control" placeholder="Name">
                                            <input type="text" id="sup_name_for_invo" class="form-control" placeholder="Name for Invoice">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="sub_cat_name" class="col-lg-4 control-label custom-label">Address :</label>
                                        <div class="col-lg-6">
                                            <input type="text" id="address" class="form-control" placeholder="General">
                                            <input type="text" id="address_for_invo" class="form-control" placeholder="Address for Invoice">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="sub_cat_name" class="col-lg-4 control-label custom-label">Phone No. :</label>
                                        <div class="col-lg-6">
                                            <input type="text" id="phone_no" class="form-control" placeholder="General">
                                            <input type="text" id="phone_no_for_invo" class="form-control" placeholder="Phone No. for invoice">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="sub_cat_name" class="col-lg-4 control-label custom-label">Fax :</label>
                                        <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-4 col-lg-10">
                                            <span  id="save_div" class="">
                                                <button class="btn btn-custom-save" id="btn_supp_add" onkeyup=""><i class="fa fa-plus-square fa-lg"></i>&nbsp;Add</button>
                                            </span>
                                            <span  id="update_div">
