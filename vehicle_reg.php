                                ...
                                <div class="tab-pane active" id="vh_info_tab">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                <label class="col-lg-4 control-label custom-label">Engine Code :</label>
                                                <div class="col-lg-6">
                                                    <input type="text" id="v_eng_code" class="form-control custom-text1"  style="text-transform:uppercase" onkeyup="set_focus_next(event, '#v_eng_num')">                        
                                                </div>
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group hidden">
                                                <label class="col-lg-4 control-label custom-label">Evaluation Grade :</label>
                                                <div class="col-lg-6">
                                                    <input type="hidden" id="v_eval" class="form-control custom-text1" onkeyup="set_focus_next(event, '#v_milage')">
                                                </div>
                                            </div>
                                            <div class="form-group">
...
//                    chosenRefresh();
                    ...
                    load_suppliers_cmb(false, function () {
                        load_supp_currency($('.v_supplier').val());
                    });
                }
