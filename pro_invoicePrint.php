...
//            echo 'num rows : ' . $numrows;
                ...
                <form action="download.php" method="post" style="">
                    <div style="" >
                        ...
                        <input type="text" name="email_cc1" value="contact@siyekra.com" placeholder="CC"/>
                        <input type="text" name="email_cc2" value='<?php  ?>' placeholder="CC"/>
                        <input type="hidden" name="print_template" value='pro_invoicePrint.php' placeholder="CC"/>
                    </div>
